...
import com.staffing.manageemployee.Addmanageaddresspage;
import com.staffing.utility.Autofilloption;
import com.staffing.utility.ScreenShot;
import com.staffing.utility.Slider;

public class Manageemployeeaddressdetails extends Constants{
	FileInputStream f;
	XSSFWorkbook wb;
	XSSFSheet ws;
	FileOutputStream f1;
	@Test
	public  void enterAddressDetails() throws IOException, InterruptedException
	{
		String result = null;
		...
		Addmanageaddresspage aeap=PageFactory.initElements(driver, Addmanageaddresspage.class);
		...
		for (int i = 1; i <= lastrownum; i++) 
		{
			...
			ep.AddNew();
			Row r=ws.getRow(i);
			String title=aeap.addManageAddressDetails(driver, r);
			...
			else
			{
				...
				String fail="manageaddressfail"+Integer.toString(i);
