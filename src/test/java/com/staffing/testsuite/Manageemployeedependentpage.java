...
import com.staffing.manageemployee.Addmanagedependentpage;
import com.staffing.utility.Autofilloption;
import com.staffing.utility.ScreenShot;
import com.staffing.utility.Slider;

public class Manageemployeedependentpage extends Constants{
	FileInputStream f;
	XSSFWorkbook wb;
	XSSFSheet ws;
	FileOutputStream f1;
	@Test
	public  void enterDependentDetails() throws IOException, InterruptedException
	{
		String result = null;
		...
		Addmanagedependentpage amdp=PageFactory.initElements(driver, Addmanagedependentpage.class);
		...
		for (int i = 1; i <= lastrownum; i++) 
		{
			...
			ep.AddNew();
			Row r=ws.getRow(i);
			String title=amdp.addDependentDetails(r);
			...
			else
			{
				...
				String fail="managedependentfail"+Integer.toString(i);
