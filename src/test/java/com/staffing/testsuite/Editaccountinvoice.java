...
import com.staffing.editaccounts.Editinvoice;
import com.staffing.utility.ScreenShot;

public class Editaccountinvoice extends Constants{
	FileInputStream f;
	XSSFWorkbook wb;
	XSSFSheet ws;
	FileOutputStream f1;
	...
	int count=0;
	@Test
	public void editaccountemppay() throws IOException, InterruptedException
	{
		...
		Editinvoice einv=PageFactory.initElements(driver, Editinvoice.class);
		l.button();
		Thread.sleep(2000);
		...
		f1=new FileOutputStream(accountsinvoiceres);
		wb.write(f1);
		f1.close();
		Thread.sleep(500);
