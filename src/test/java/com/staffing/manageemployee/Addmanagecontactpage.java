...
public class Addmanagecontactpage {
	FirefoxDriver driver;
	@FindBy(xpath="//*[@id='add_contacts']/div/div/div[1]/div[2]/input")
	WebElement name;
	@FindBy(xpath="//*[@id='add_contacts']/div/div/div[2]/div[1]/input")
	WebElement email;
	@FindBy(xpath="//*[@id='add_contacts']/div/div/div[1]/div[3]/select")
	...
	@FindBy(xpath="//*[@id='addModal']/div/div/div[3]/input[1]")
	WebElement save;
